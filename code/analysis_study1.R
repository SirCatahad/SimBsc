...
complete_df[grepl('m1', complete_df$Condition), "MatchType"] <- "Type 1"
complete_df[grepl('m2', complete_df$Condition), "MatchType"] <- "Type 2"

complete_df["method"] <- NA
complete_df[grepl('complete_data', complete_df$Condition), "method"] <- "Complete"
complete_df[grepl('incomplete', complete_df$Condition), "method"] <- "Complete Cases"
...
complete_df[grepl('k10', complete_df$Condition), "k"] <- "k= 10"
